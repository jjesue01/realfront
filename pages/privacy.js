      ...
      <div className={styles.policyContainer}>
        ...
        <section className={styles.policyItem}>
          ...
          <ul>
            ...
            <li>We may also collect Personal Data at other points in our Service where you voluntarily provide it or where we state that Personal Data is being collected.</li>
          </ul>
        ...
        <section className={styles.policyItem}>
          ...
          <p>We may create Anonymous Data records from Personal Data. We use this Anonymous Data to analyze request and usage patterns so that we may improve our Services and enhance Service navigation. We reserve the right to use Anonymous Data for any purpose and to disclose Anonymous Data to third parties without restriction.</p>
        </section>
        <section className={styles.policyItem}>
