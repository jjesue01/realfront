        ...
        <div className={styles.content}>
          ...
          <div className={styles.info}>
            ...
            <Typography
              ...
              margin={'32px 0 0'}
              color={'rgba(55, 65, 81, 0.8)'}>
              When you purchase an NFT from HomeJab, you are not only owning a piece of real world history, you are supporting a real life artist that desperately needs your help. Most photographers work as independent contractors, with no employee protections, unions, pensions or any security for their services. Once the work is published, the possession is out of the artist’s control. The HomeJab NFT Marketplace is the only place, real or digital, that secures their efforts and the ongoing value they provide.
            </Typography>
            <Typography
              fontFamily={'Lato'}
              fontSize={16}
